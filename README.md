...
> Άνοιγμα αυτής της σελίδας στο [https://chzarafidis.github.io/ble-control/](https://chzarafidis.github.io/ble-control/)
...
* αναζήτηση για **https://github.com/chzarafidis/ble-control** και εισαγωγή

## Επεξεργασία αυτού του έργου ![Σήμα κατάστασης κατασκευής](https://github.com/chzarafidis/ble-control/workflows/MakeCode/badge.svg)

Για επεξεργασία αυτού του αποθετηρίου στο MakeCode.

* άνοιγμα [https://makecode.microbit.org/](https://makecode.microbit.org/)
* κάντε κλικ στην **Εισαγωγή** και έπειτα στην **Εισαγωγή διεύθυνσης URL**
* επικολλήστε **https://github.com/chzarafidis/ble-control** και κάντε κλικ στην εισαγωγή
...
![Προβολή απόδοσης των μπλοκ](https://github.com/chzarafidis/ble-control/raw/master/.github/makecode/blocks.png)
